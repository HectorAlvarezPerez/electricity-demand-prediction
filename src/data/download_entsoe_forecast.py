...
def download_country_forecast(
    ...
    *,
    ...
    for year in range(start_year, end_year + 1):
        ...
        print(f"[{country_code}] downloading day-ahead load forecast for {year}...")
        try:
            ...
            print(f"[{country_code}] {year} failed: {exc}")
    ...
    print(f"[{country_code}] saved -> {out_path}")
    return out_path
...
def main() -> None:
    ...
    for code in COUNTRIES:
        download_country_forecast(client, code, output_dir)

    print("\nAll ENTSO-E day-ahead load forecasts downloaded.")
